...
public class SimplePr@@oducer {
    ...
    public static void main(String[] args) {
        SimpleProducer simpleProducer = new SimpleProducer(2,(int)Math.pow(10,6), "topic1", 9092); // entre 45 et 50 secondes avec des consommateurs seuls
